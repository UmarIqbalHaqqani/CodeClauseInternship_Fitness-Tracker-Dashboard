<?php
vc_map( array(
    "name" => esc_html__( "Single Event Modern", 'dt-event-manager' ),
    "base" => "dt_sc_event_single_modern",
    "icon" => "dt_sc_event_single_modern",
    ...
    "params" => array(
        ...
        array(
        	...
        	'heading' => esc_html__('Hover Text', 'dt-event-manager'),
        	'save_always' => true,
        	'value' => esc_html__('Read More', 'dt-event-manager'),
        	'edit_field_class' => 'vc_col-sm-6 vc_column',
        	'dependency' => array( 'element' => 'show_read_more', 'value' => 'yes' ),
        ),
