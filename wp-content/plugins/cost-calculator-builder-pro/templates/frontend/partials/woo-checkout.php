...
?>
<div class="calc-buttons <?php echo ! empty( $invoice ) && $invoice['emailButton'] && $invoice['use_in_all'] && ! $invoice['showAfterPayment'] ? esc_attr( 'pdf-enable' ) : ''; ?>" style="min-height: 50px; margin-top: 20px; position: relative" v-if="getWooCheckoutSettings.enable">
