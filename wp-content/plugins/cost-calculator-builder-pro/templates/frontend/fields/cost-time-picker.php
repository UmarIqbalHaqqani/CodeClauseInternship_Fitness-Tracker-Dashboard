...
<div :style="additionalCss" class="calc-item ccb-field" :class="[timePickerField.additionalStyles, {required: requiredActive}]" :data-id="timePickerField.alias" :data-repeater="repeater">
