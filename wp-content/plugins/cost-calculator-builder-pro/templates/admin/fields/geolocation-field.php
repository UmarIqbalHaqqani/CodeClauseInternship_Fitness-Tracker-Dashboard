			...
			<div class="row ccb-p-t-15">
				<div class="col-12">
					<div class="ccb-radio-wrapper">
						...
						<span class="description"><?php esc_html_e( 'Let them calculate the distance from their location to your place', 'cost-calculator-builder-pro' ); ?></span>
					</div>
				</div>
				<div class="col-12 ccb-p-t-20">
					<div class="ccb-radio-wrapper">
						...
						<span class="description"><?php esc_html_e( 'Let them calculate the distance between two places for your mover or taxi services', 'cost-calculator-builder-pro' ); ?></span>
					</div>
				</div>
				<div class="col-12 ccb-p-t-20 ccb-p-b-10">
					<div class="ccb-radio-wrapper">
						...
						<span class="description"><?php esc_html_e( 'It can be used to select a pick-up location or branch', 'cost-calculator-builder-pro' ); ?></span>
					</div>
				</div>
			...
			<div class="row ccb-p-t-15" v-show="geolocationField.geoType === 'userLocation'">
				...
				<div class="col-12 ccb-p-t-15" v-show="geolocationField.costDistance">
					<div class="row vertical-center">
						<div class="col-7">
							<div class="ccb-input-wrapper">
								<span class="ccb-input-label"><?php esc_html_e( 'Add your location', 'cost-calculator-builder-pro' ); ?></span>
							</div>
						</div>
