	...
	<div class="ccb-grid-box">
		<div class="container">
					...
					<div class="col-12">
						<div class="list-header">
							<div class="ccb-multiply">
								...
								<div class="ccb-input-wrapper number">
									<div class="ccb-input-box">
										<input type="text" class="ccb-heading-5 ccb-light" name="unit" min="1" step="1" @keypress="unitMinValue" v-model="multiRangeField.unit" placeholder="<?php esc_attr_e( 'Enter unit', 'cost-calculator-builder-pro' ); ?>">
			...
			<template v-else>
				...
				<div class="row-currency" :class="{'disabled': !multiRangeField.fieldCurrency}">
					<div class="col-4">
						<div class="ccb-input-wrapper">
