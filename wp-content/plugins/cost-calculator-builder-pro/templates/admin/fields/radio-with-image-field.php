	...
	<div class="ccb-grid-box">
		...
		<div class="container" v-show="tab === 'main'">
			...
			<div class="row ccb-p-t-15">
				...
				<div class="col-6">
					<div class="ccb-select-box">
						<span class="ccb-select-label"><?php esc_html_e( 'Type of Label in Total', 'cost-calculator-builder-pro' ); ?></span>
						<div class="ccb-select-wrapper">
							<i class="ccb-icon-Path-3485 ccb-select-arrow"></i>
							<select class="ccb-select big" v-model="radioField.summary_view">
								...
								<option value="show_label_not_calculable"><?php esc_html_e( 'Label Only (No Calculation)', 'cost-calculator-builder-pro' ); ?></option>
								<option value="show_label_calculable"><?php esc_html_e( 'Label Only (Calculate Value)', 'cost-calculator-builder-pro' ); ?></option>
							</select>
						</div>
					</div>
				</div>
		...
		<div class="container" v-show="tab === 'style' && typeof radioField.styles !== 'undefined'">
			<div class="row ccb-p-t-15" style="align-items: flex-end !important;" v-if="radioField.styles">
				...
				<div class="col-6" v-if="radioField.styles.style">
					<div class="ccb-select-box">
			...
			<div class="row ccb-p-t-15">
				<div class="col-12">
					<div class="list-header">
						...
						<h6 class="ccb-heading-5" style="font-size: 14px"><?php esc_html_e( 'Apply this radio style to all radio fields in this calculator', 'cost-calculator-builder-pro' ); ?></h6>
					</div>
				</div>
			</div>
		</div>
