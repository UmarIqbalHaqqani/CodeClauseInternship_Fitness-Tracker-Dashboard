			...
			<div class="row">
				...
				<div class="col-12 ccb-p-t-20">
					<div class="list-header">
						...
						<p>
							<?php esc_html_e( 'It makes the group hidden by default. Open "Conditions" tab and create a condition with this field so users can reveal it.', 'cost-calculator-builder-pro' ); ?>
						</p>
					</div>
				</div>
			</div>
