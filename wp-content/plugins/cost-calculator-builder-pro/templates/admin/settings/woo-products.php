						...
						<div class="ccb-select-box">
							...
							<div class="ccb-select-wrapper">
								<div class="ccb-multi-select" @click="multiselectShow(event)">
									...
									<ul class="items row-list settings-list totals">
										<li @click.prevent="multiselectChooseWooProducts('all')" class="option-item settings-item">
										...
										<li @click.prevent="multiselectChooseWooProducts(product.ID)" class="option-item settings-item" v-for="product in $store.getters.getProducts" :key="product.ID" :value="product.ID" v-if="product">
											...
											<label :for="'woo_product_id_' + product.ID" class="ccb-heading-5">{{ product.post_title }}</label>
										</li>
									</ul>
								</div>
							</div>
