...
<div class="thank-you-page-notice" v-if="showNotice">
	<span v-html="'<?php echo esc_attr( sprintf( __( 'Note: %1$s will be shown only if %2$s is enabled or %3$s', 'cost-calculator-builder-pro' ), '<b>“Confirmation page”</b>', '<b>Contact form</b>', '<b>Payment integration made</b>' ) ); ?>'"></span>
</div>
